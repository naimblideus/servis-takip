...
const menuItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5a1.99 1.99 0 011.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.99 1.99 0 013 9V4a1 1 0 011-1z" />
      </svg>
    ),
  },
  {
    ...
    <>
      ...
      <div id="app-topbar" className="md:hidden fixed top-0 left-0 right-0 h-14 bg-gray-900 z-40 flex items-center gap-3 px-4 print:hidden">
        ...
        <div className="flex items-center gap-2 min-w-0">
          <span className="text-white font-semibold text-sm whitespace-nowrap">Nextus Servis</span>
