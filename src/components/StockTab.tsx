    ...
    <div style={{padding:'0 0 2rem'}}>
      ...
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'1.25rem'}}>
        <div>
          ...
          <p style={{color:'#6b7280',margin:'0.2rem 0 0',fontSize:'0.85rem'}}>Parça, sarf malzeme ve yazıcı stoklarınız</p>
        </div>
      ...
      <div style={{display:'flex',gap:'0.75rem',marginBottom:'1rem',alignItems:'center'}}>
        ...
        <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="🔍 Stokta ara..." style={{...s.inp,flex:1,backgroundColor:'#f9fafb'}} />
      </div>
