...
<nav class="nav" id="nav">
  <div class="nav-inner">
    ...
    <div class="nav-cta">
      <!-- Demoyu Dene: ÖRNEK VERİLİ ayrı hesaba gider (scripts/seed-demo.mjs).
           Gerçek bayi hesabına ASLA bağlanmamalı — orada o bayinin müşteri
           adları, cihaz sayıları ve fiyatları var. -->
      <a href="/login?demo=1" class="btn btn-ghost btn-sm nav-demo">Demoyu Dene</a>
