...
<header>
  <div class="wrap">
    <nav>
      <a href="#" class="brand"><span class="dot"></span> Nexus Servis</a>
      ...
      <div class="nav-cta">
        <!-- /login app içinde doğru. Landing'i ayrı domaine taşırsan tam URL yaz (ör. https://app.nexusservis.com/login) -->
...
<section class="hero wrap">
  ...
  <div class="mock">
    ...
    <div class="mock-frame">
      <div class="mock-bar"><i style="background:#ff5f57"></i><i style="background:#febc2e"></i><i style="background:#28c840"></i><span class="u">app.nexusservis.com/panel</span><span class="demo">örnek ekran</span></div>
      <div class="mock-body">
        <div class="mock-side">
...
<section class="pad wrap" id="neden">
  <div class="shead reveal">
    ...
    <h2>Manuel kaos &nbsp;→&nbsp; Nexus Servis düzeni</h2>
...
<section class="pad wrap" id="hesapla">
  <div class="calc reveal-scale">
    ...
    <div class="result">
      ...
      <div class="lossbox">⚠️ Bu para zaten <b>sizin</b> — sadece faturalanmadığı için cebinizde değil. Nexus Servis aylık ücretini <span class="em">ilk haftada</span> çıkarır.</div>
...
<section class="pad wrap">
  ...
  <div class="grid reveal-stagger">
    ...
    <div class="fcard"><div class="fi">🧮</div><h3>"Logo'm var"</h3><p>Logo muhasebeyi tutar; sayaç-kira ve saha servisini bilmez. Nexus Servis servisi yönetir, faturayı üretir, <b style="color:var(--text)">veriyi Logo'ya akıtır.</b> Rakip değil, Logo'nuzu besler.</p></div>
...
<section class="pad wrap" id="kurucu">
  <div class="founder reveal">
    ...
    <div>
      ...
      <p>"Bir fotokopi bayisinin sayaç okumayı kaçırdığı için her ay binlerce lira eksik faturaladığını gördüm. Buna dayanamadım — çözümünü sahada, bayinin yanında oturup yazdım. Nexus Servis masa başında değil, gerçek bir işin içinde doğdu. Sorun yaşayan kim varsa, doğrudan bana yazabilir."</p>
      <div class="socials">
        <!-- DEĞİŞTİR: gerçek profil linkleri (yoksa o anchor'ı sil) -->
        <a href="#" target="_blank" rel="noopener">in/ LinkedIn</a>
        <a href="#" target="_blank" rel="noopener">@ Instagram</a>
        <a data-wa data-wa-text="Merhaba Mehmet Bey, Nexus Servis hakkında size yazıyorum">💬 Doğrudan bana yaz</a>
      </div>
    </div>
  </div>
</section>
...
<section class="pad wrap">
  ...
  <div class="faq reveal">
    ...
    <details class="qa"><summary>Logo / muhasebe programım var, yine de gerekir mi?</summary><div class="a">Evet, çünkü Logo sayaç-kira mantığını ve saha servisini bilmez. Nexus Servis servis tarafını yönetir, faturayı otomatik üretir ve verisini Logo'ya akıtır — rakip değil, tamamlayıcıdır.</div></details>
...
<section class="pad wrap" id="basla">
  <div class="final reveal-scale">
    ...
    <div class="form-alt">
      <a class="btn wa" data-wa data-wa-text="Merhaba, Nexus Servis demosu istiyorum">💬 Formla uğraşma — WhatsApp'tan 2 dakikada demo iste</a>
    </div>
...
<footer>
  <div class="wrap foot">
    <div><span class="brand" style="font-size:1.1rem"><span class="dot"></span> Nexus Servis</span><div style="margin-top:8px">Kiralık cihaz servis & sayaç-kira yönetimi</div></div>
    ...
    <div>© 2026 Nexus Servis · Tüm hakları saklıdır</div>
  </div>
</footer>
...
<div class="mcta" id="mcta">
  <a class="btn lp-btn-primary" href="#basla">14 Gün Ücretsiz →</a>
  <a class="btn wa" data-wa data-wa-text="Merhaba, Nexus Servis demosu istiyorum" aria-label="WhatsApp ile demo iste">💬</a>
</div>
...
const JS = `
  ...
  function calc(fromUser){
    ...
    roi.innerHTML = net>0
      ...
      : 'Nexus Servis Profesyonel — kaçağınızı görünür kılar.';
  }
  ...
  // Lead formu -> CRM (ateşle-unut) + WhatsApp (popup engellenirse tıklanabilir link gösterilir)
  document.getElementById('leadForm').addEventListener('submit',function(e){
    e.preventDefault();
    var f=this;
    // Kullanıcı WhatsApp mesajını göndermese bile lead CRM'e düşsün.
    // Hata olursa yutulur; WhatsApp akışı hiçbir koşulda etkilenmez.
    try{
      fetch('/api/talep',{
        method:'POST',
        ...
        keepalive:true,
        body:JSON.stringify({
          firma:f.firma.value||'', ad:f.ad.value||'', telefon:f.telefon.value||'',
          utm_source:f.utm_source.value||'', utm_campaign:f.utm_campaign.value||''
        })
      }).catch(function(){});
    }catch(_e){}
    var text='Merhaba, Nexus Servis denemek istiyorum.\\n'
      +'Firma: '+(f.firma.value||'-')+'\\n'
      +'Ad: '+(f.ad.value||'-')+'\\n'
  ...
  (function(){
    ...
    document.querySelectorAll('[data-wa]').forEach(function(a){
      var t=a.getAttribute('data-wa-text')||'Merhaba, Nexus Servis hakkında bilgi almak istiyorum';
