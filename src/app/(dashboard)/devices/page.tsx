    ...
    <div style={{ padding: '2rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          ...
          <p style={{ color: '#6b7280' }}>Toplam {devices.length} cihaz</p>
        </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ backgroundColor: '#f9fafb', borderBottom: '1px solid #e5e7eb' }}>
              {['Marka / Model', 'Seri No', 'Müşteri', 'Konum', 'Son Fiş', ''].map(h => (
          ...
          <tbody>
            ...
            {devices.length === 0 && (
              <tr><td colSpan={6} style={{ padding: '3rem', textAlign: 'center', color: '#6b7280' }}>Henüz cihaz yok</td></tr>
            )}
          </tbody>
        </table>
      </div>
