# Nexus Servis — Pazarlama Paketi

> Nexus Servis ürününün pazarlama sistemi. **Tek odak: sadece servis takibini pazarlıyoruz**
> (rent-a-car / makine-takip bu kampanyada yok). Kurucu kişisel markası (Mehmet Naim) ile birlikte yürür.

## İçindekiler
| Dosya | Ne işe yarar |
|---|---|
| [00-MARKA-VE-ISIM.md](00-MARKA-VE-ISIM.md) | Marka kimliği: **"Nexus Servis" kararı**, jenerik ismi çalıştırma (SEO/tescil), ton, renk, logo, domain checklist |
| [01-GTM-STRATEJI.md](01-GTM-STRATEJI.md) | ICP, konumlandırma, fiyat (₺1.749/2.099/5.249 — decoy yapısı), kanallar, huni, 90 günlük plan, metrikler |
...
## YAPILDI ✅
- [x] Marka kararı: "Nexus Servis" (00) + tüm paket bu isme çevrildi
